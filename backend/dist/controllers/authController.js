...
class AuthController {
    ...
    static async updateProfile(req, res) {
        try {
            ...
            if (avatar !== undefined)
                user.avatar = avatar;
            await user.save();
            logger_1.logger.info('Profile updated successfully', { userId: user._id });
            res.status(200).json({
                success: true,
                data: {
                    user: {
    ...
    static async changePassword(req, res) {
        try {
            ...
            await user.save();
            logger_1.logger.info('Password changed successfully', { userId: user._id });
            res.status(200).json({
                success: true,
    ...
    static async deactivateAccount(req, res) {
        try {
            ...
            user.isActive = false;
            await user.save();
            logger_1.logger.info('Account deactivated', { userId: user._id });
            res.status(200).json({
                success: true,
